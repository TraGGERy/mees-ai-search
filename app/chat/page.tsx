          ...
          <div className="max-w-3xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
            <form onSubmit={handleNewSubmit} className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 sm:p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-500 disabled:opacity-40 disabled:hover:text-gray-400 dark:disabled:hover:text-gray-500 transition-colors duration-200"
              >
