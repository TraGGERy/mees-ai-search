...
An AI-powered academic search engine and research assistant with a generative UI.
...
📝 Explore AI-generated documentation on [DeepWiki](https://deepwiki.com/miurla/mees-ai)

## 🛠 Features

### Core Features

- AI-powered academic search with GenerativeUI
- Academic paper analysis and summarization
- Literature review assistance and research synthesis
- Natural language question understanding for scholarly queries
- Multiple search providers support (Tavily, SearXNG, Exa) optimized for academic content
- Model selection from UI (switch between available AI models)
  - Reasoning models with visible thought process and citation tracking
